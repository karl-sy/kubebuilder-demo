...
//+kubebuilder:rbac:groups=ingress.karl.tech,resources=apps,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=ingress.karl.tech,resources=apps/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=ingress.karl.tech,resources=apps/finalizers,verbs=update
